...
import { PartialInvoicesReportComponent } from "@/src/components/Invoices/PartialInvoicesReport/PartialInvoicesReportComponent";
...
export default function PartialInvoicesReport() {
  ...
  return(
    <main className="p-5">
      <PartialInvoicesReportComponent InvoiceId={invoiceId} />
    </main>
  );
}
