...
import { FlattenedInvoice, PartialInvoicesTableProps } from "@/src/types/invoices";
...
export const PartialInvoicesListTable: React.FC<PartialInvoicesTableProps> = ({
  ...
  const columns: TableColumnsType<FlattenedInvoice> = [
    ...
    },
    {
      title: "Payment Date",
      render: (record: FlattenedInvoice) =>
        record.sub_item?.invoice_date
          ? dayjs(record.sub_item.invoice_date).format("DD MMM YYYY")
          : "-",
    },
    {
      title: "Paid Amount",
