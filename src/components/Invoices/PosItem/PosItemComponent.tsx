...
import { InvoiceData, InvoiceItem, InvoicesItemProps } from "@/src/types/invoices";
...
export const PosItemComponent = ({ InvoiceId }: InvoicesItemProps) => {
  ...
  const generateQRData = () => {
    ...
    return [
      ...
      `Inv Date: ${formatDate(invoiceData.invoice_date)}`,
    ].join("\n");
  };
      ...
      <div className="flex justify-center px-4 mx-auto pb-10">
        ...
        >
          ...
          <div className="text-center my-1">
            ...
            <div>Invoice Date: {formatDate(invoiceData.invoice_date)}</div>
          </div>
