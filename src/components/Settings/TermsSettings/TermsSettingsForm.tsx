...
import { TermsItem } from "@/src/types/terms";
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2 mb-4 mt-2">
          <input
            ...
            className="border text-[14px] text-black py-2 px-4 w-full flex-1 bg-[#F2F4F7] hover:border-[#B9C1CC] focus:outline-none focus:border-[#B9C1CC] rounded-md"
            disabled={
