  ...
  const columns: ColumnsType<CurrencyType> = [
    ...
    },
    {
      ...
      render: (countryCode: string) => (
        <Image
          src={`https://flagcdn.com/w40/${countryCode}.webp`}
          width="40"
          height="30"
      ...
      <div className="flex sm:justify-between justify-end items-center mb-5">
        ...
        <div className="flex items-center justify-end gap-2">
          <input
            type="text"
            placeholder="Search..."
            className="border text-[14px] sm:w-40 w-32 py-1 px-[10px] bg-[#F2F4F7] hover:border-[#B9C1CC] focus:outline-none focus:border-[#B9C1CC] rounded-md transition-all duration-300 mt-2"
            value={searchText}
